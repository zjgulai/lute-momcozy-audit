...
| # | 类别 | 标题 | ROI 估 (假设) |
|---|---|---|---|
| P0-1 | 性能 | DOM 节点超载 PDP 5375 | $3.6M/mo |
| P0-2 | 性能 | LCP 像素 24M（Hero 图过大）| $6.0M/mo |
| P0-3 | 性能 | HTML 体积膨胀 PDP 1.8MB | $2.4M/mo |
| P0-4 | 性能 | webp 仅 2%（295 图）| ~$200/h/mo |
| P0-5 | 性能 | PDP 第三方域 72 | $3.2M/mo |
...
**累计 P0 估增收（真实月入 $11.5M 基线）**：~$10-16M / 月（保守 $8-13M）
...
预估 P0 全修复月增收 **$10-16M**（按真实月入 $11.5M 基线 / CVR 0.88% / AOV $119）。
P0 全修预计工时 30-50 工程师工时 · 投资回报期 < 1 周。

## Top 5 投资 ROI（按真实月入 $11.5M） 排序

| # | 动作 | 工时 | 月增收 | ROI |
|---|---|---|---|---|
| 1 | LCP Hero 图优化 | 4h | $6.0M | 极高 |
| 2 | DOM PDP 砍 50% | 16h | $3.6M | 高 |
| 3 | HTML 体积砍（FastBundle/Globo 外置）| 8h | $2.4M | 高 |
| 4 | webp 全站启用 | 2h | ~$200/h | 极高 |
| 5 | PDP 第三方域审查 + 砍 30+ | 8h | $3.2M | 中 |

## 立即决策点
- **优先级 #1** Hero 图（4h $6.0M 月增）· 即刻可做
...
| **合计**（互相影响交叉，**非简单相加**）| | | **~$10-16M / 月（保守 $8-13M）** |
